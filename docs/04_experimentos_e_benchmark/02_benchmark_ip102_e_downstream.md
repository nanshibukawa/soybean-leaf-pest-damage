...
1. **Passo 1 — Domain-Specific Pre-training (IP102):**
   ...
   * **Mecanismo de Atenção/Pooling:** [**Top-K Adaptive Pooling**](../01_ROTEIRO_TECNICO_E_METODOLOGICO.md) ($k = 0.15$) para focar nas $15\%$ ativações espaciais mais intensas da praga, descartando o ruído de fundo sem introduzir parâmetros treináveis adicionais.
